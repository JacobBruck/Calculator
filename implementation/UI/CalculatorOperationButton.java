 ...
 * @author Jacob Bruck
 *
 * Created at     : 2022-11-15 16:37:09 
 * Last modified  : 2022-11-15 16:37:09 
 */
...
/**
 * the class that implemnts the UI for the operation 
 * button.  The button will have the actionlistener
 * to send the text to the "registers."
 */
public class CalculatorOperationButton extends JButton {
    ...
    public CalculatorOperationButton (CalculatorOperationPanel parent, String value) {
        ...
        setText(value);
        //this builds an anonymous inner class that will be the action listener.
        this.addActionListener(e -> {
            ...
            m_parent.getCalculatorFrame().setDisplayValue(btn.getText());
